...
public class GestionarComicPOJO {
	...
	public ComicDTO crearComicDTO(String id, String nombre, String editorial, TematicaEnum tematicaEnum, String coleccion,
		...
		ComicDTO comicDTO = new ComicDTO(id, nombre, editorial, tematicaEnum, coleccion,numeroPaginas, precio, autores, color, fechaVenta, estado, cantidad);
	...
	public void crearComicDTO() {
		...
		comicDTO.setColeccion("Manga Shomen");
